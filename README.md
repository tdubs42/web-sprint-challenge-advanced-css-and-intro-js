...
1. How would you describe acessibility on the web to someone new to programming?
   Acessibility is key to ensuring you have the largest reach and scope for your program. Ensuring you program with visual impairment, hearing impairment, and others will ensure that your product is inclusive. This is key to any program moving forward.

2. Talk about 3 different things you can do to ensure your website is accessible.
   Ensuring high contrast in the color scheme
   Using accurate alt text for photos and diagrams
   Semantic HTML to ensure screen readers and other acessibility software can properly travel through a program

3. How would you explain the concept of a variable to someone new to programming?
   A variable is like a box that you put something into. You use a variable to store data that you want to be able to access with one reference, or has similar traits.

4. What is the purpose of using functions in code?
   Functions allow us somewhat of the same freedom as variables. Once you create a function, you can always callback to that function. This becomes really useful when you want to carry over features to multiple programs, pages, etc.
